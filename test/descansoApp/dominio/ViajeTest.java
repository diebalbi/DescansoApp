...
public class ViajeTest {
    ...
    public void testToString() throws Exception {
        ...
        fF.roll(Calendar.DAY_OF_MONTH, true);
        v1.setFechaF(fI, fF);

        SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
        String dateFrom = formatter.format(fI.getTime());
        String dateTo = formatter.format(fF.getTime());
        
        String expResult = " (" + dateFrom + " - " + dateTo + ")";
