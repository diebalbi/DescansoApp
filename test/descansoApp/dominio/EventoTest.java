...
public class EventoTest {
    ...
    public void testHoraInicioToString() throws Exception {
        ...
        fI.roll(Calendar.DAY_OF_MONTH, true);
        e.setFechaHoraI(fI);
        
        SimpleDateFormat formatter = new SimpleDateFormat("HH:mm");
        String expResult = formatter.format(fI.getTime());
    ...
    public void testCompareTo2() throws Exception {
        ...
        f1.roll(Calendar.MONTH, true);
        e1.setFechaHoraI(f1);
        Evento e2= new Evento();
        Calendar f2= Calendar.getInstance();
        f2.roll(Calendar.DAY_OF_MONTH, true);
        e2.setFechaHoraI(f2);
    ...
    public void testCompareTo3() throws Exception {
        ...
        Evento e1= new Evento();
        Calendar f1= Calendar.getInstance();
        f1.roll(Calendar.DAY_OF_MONTH, true);
        e1.setFechaHoraI(f1);
        Evento e2= new Evento();
        Calendar f2= Calendar.getInstance();
        f2.roll(Calendar.MONTH, true);
        e2.setFechaHoraI(f2);
